...
export default function Authentication() {
        ...
        <div className='auth-card-box'>
          ...
          <div className='auth-card-bottom'>
            ...
            <div className='auth-sign-in-error-box'>
              <div className='auth-sigin-in-error-message'>
  ...
  const SignUpCard = () =>{
    ...
    //          event handler: 닉네임 변경 클릭 이벤트 처리          //
    ...
    const onAgreedPersonalClcikHandler = () => {
    ...
    const onNextButtonClickHandler = () => {
      ...
      if(!isEqualPassword){
        ...
        setPasswordErrorMessage('비밀번호가 일치하지않습니다.');
      }
    ...
    const onSignUpButtonClickHandler = () => {
      ...
      const isTelNumberPattern = telNumberPattern.test(telNumber); // test() : telNumber 패턴을 체크
        ...
        <div className='auth-card-box'>
          ...
          <div className='auth-card-bottom'>
            ...
            <div className='auth-consent-box'>
              <div className='auth-check-box' onClick={onAgreedPersonalClcikHandler}>
        ...
        <div className='auth-jumbotron-box'>
          <div className='auth-jumbotron-contents'>
            ...
            <div className='auth-jumbotron-text-box'>
              ...
              <div className='auth-jumbotron-text'>{'Luke Daily Blog 입니다.'}</div>
            </div>
          </div>
        </div>
